...
public class AVCallFloatView extends FrameLayout {
    private static final String TAG = "lhl-->AVCallFloatView";
    ...
    private void initView() {
        ...
        View floatView = inflater.inflate(R.layout.activity_floating, null);
        addView(floatView);
    ...
    private class AnchorAnimRunnable implements Runnable {
        ...
        public void run() {
            ...
            Log.i(TAG, "delta:  " + delta + "  xMoveDistance  " + xMoveDistance + "   yMoveDistance  " + yMoveDistance);
